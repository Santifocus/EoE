...
namespace EoE.Information
{
	...
	public class EnemySettingsEditor : EntitieSettingsEditor
	{
		...
		protected override void StatSettingsArea()
		{
			...
			EoEEditor.FloatField(new GUIContent("Attack Range", "At which distance to the player should this Enemy change into its combat behavior?"), ref (target as EnemySettings).AttackRange);
		}
		protected virtual void PlayerChasingArea()
		{
			EnemySettings settings = target as EnemySettings;

			EoEEditor.Header("Player Chasing Settings");
