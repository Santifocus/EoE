...
namespace EoE.Information
{
	...
	public class EnemySettingsEditor : EntitieSettingsEditor
	{
		...
		protected virtual void PlayerChasingArea()
		{
			...
			FloatField(new GUIContent("Look Around After Lost Player Time", "After losing sight of the Player how long should this Enemy look around in search of the player? (Goes back to wandering / Ideling afterwards)"), ref settings.LookAroundAfterLostPlayerTime);
		}
